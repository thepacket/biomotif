...
/** The served build keeps itself for use without a connection. The single
    file has no worker to register, and a viewer that embeds the page has no
    scope for one; both are told apart by there being no bundle to point at. */
